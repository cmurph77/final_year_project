...
# Footer
    ...
    # 098765432 file
    with open("manhattan.rou.xml", "w") as file:
...
def run():
    ...
    # print(routeInfo)
    veh_id = "one"
    ny_route = ('road_D','road_C')
    traci.route.add('ny_route', ny_route)
    traci.vehicle.add(vehID=veh_id,typeID='car', routeID='ny_route')
...
if __name__ == "__main__":
    ...
    traci.start(["sumo-gui", "-c", "manhattan.sumocfg"])  # opens the gui
